...
import type { IdCardOrder } from "./IdCardOptions";
import { generatePrintIdCard } from "../../../utils/Printidcard";
...
export function IdCardArrangement() {
        ...
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-xl border-4 border-black max-w-3xl w-full">
            ...
            <p className="text-xl text-gray-600 mb-6 text-center">
              Apakah kamu sudah yakin dengan foto ID card ini?
            </p>
        ...
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-xl border-4 border-black max-w-md w-full text-center">
            ...
            <p className="text-xl text-gray-600 mb-6">
              Foto ID card berhasil disimpan dan siap diproses.
            </p>
